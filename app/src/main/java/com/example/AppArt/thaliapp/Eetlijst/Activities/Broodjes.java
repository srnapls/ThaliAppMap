...
public class Broodjes extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_broodjes);
        Bundle extras = getIntent().getExtras();
        if (extras == null) {
            lijst = null;
        } else {
            lijst = extras.getStringArray("broodjeslijst");
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            i.putExtra("broodjes", p);
            i.putExtra("bbedrag", bedrag);
            startActivity(i);
            return true;
        }
